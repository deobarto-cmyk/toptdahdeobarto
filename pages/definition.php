  ...
  <div class="container no-sidebar">
    ...
    <main>
      ...
      <section id="definition-section">
        ...
        <p>
          L'enfant qui présente un TOP s'oppose de manière <strong>active, persistante et intentionnelle</strong> aux règles. Alors que dans le TDAH seul, l'obéissance fait défaut par <em>oubli</em>, <em>inattention</em> ou <em>distraction</em>, le TOP induit une résistance frontale et délibérée face aux figures d'autorité (parents, enseignants).
        </p>
      ...
      <section id="tdah-seul" style="border-top: 4px solid var(--accent);">
        ...
        <p class="lead">
          Quand on comprend que le problème réside dans la mise en œuvre et non dans la bonne volonté, l'approche change radicalement.
        </p>
      ...
      <section id="tdah-top" style="border-top: 4px solid var(--primary);">
        ...
        <p>
          Contrairement au TDAH seul où l'enfant oublie ou est distrait ("Je ne peux pas"), le duo TDAH + TOP amène une opposition frontale et délibérée ("Je ne veux pas") :
        </p>
        <div class="matrix-grid">
          <div class="matrix-card" style="border-top: 3px solid var(--primary);">
        ...
        <div class="criteria-container">
          ...
          <div class="criteria-card">
            ...
            <div class="criteria-text">
              ...
              <p>Les enfants TOP finissent par ne recevoir de l'attention que lorsqu'ils s'opposent. Pour inverser cette dynamique, ignorez les provocations mineures non dangereuses et célébrez chaleureusement chaque petit pas vers la coopération. Donnez à la coopération une valeur relationnelle positive.</p>
            </div>
          </div>
        </div>
      </section>
