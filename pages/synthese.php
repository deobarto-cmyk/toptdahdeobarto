  ...
  <div class="container no-sidebar" id="synthese-content">
    <main>
      ...
      <section id="section-1" class="pdf-new-page">
        ...
        <p>
          L'acronyme <strong>TOP</strong> signifie <strong>Trouble Oppositionnel avec Provocation</strong>. C'est un trouble du comportement caractérisé par une désobéissance et une résistance active, répétée et intentionnelle face aux figures d'autorité (parents, enseignants), se distinguant des simples oublis ou de la distraction liés au TDAH seul.
        </p>
        <div class="alert-box" style="background:rgba(13,148,136,0.05);border-color:rgba(13,148,136,0.3);">
          📊 On estime que <strong style="color:var(--primary);">40 % à 70 % des enfants atteints de TDAH</strong> développent également un TOP, ce qui en fait une comorbidité majeure souvent sous-diagnostiquée.
        </div>
        ...
        <ul class="pretty-list" style="margin-bottom: 2rem;">
          <li>Les comportements doivent être <strong>persistants et intenses depuis plus de 6 mois</strong> pour déclencher une alerte clinique.</li>
          <li>Avant l'âge de <strong>5 ans</strong>, les comportements d'opposition font partie du développement normal de l'enfant.</li>
          <li>Un diagnostic ne peut être posé que par une <strong>équipe spécialisée et pluridisciplinaire</strong> pour éviter toute erreur.</li>
        </ul>
      ...
      <section id="section-3" class="pdf-new-page">
        ...
        <p class="lead">
          Pour rompre le cercle vicieux de l'opposition où «&nbsp;plus l'enfant provoque, plus le parent s'énerve&nbsp;», plusieurs outils concrets peuvent être appliqués&nbsp;:
        </p>
